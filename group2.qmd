...
combined_data_exercise_3 <- combined_data_exercise_3 |> mutate(turnou = total_votes / censo)
...
```{r}
# Visualization 
ggplot(performance_by_turnout, aes(x = turnout_category, y = percentage_votes, fill = party)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "How parties do depending on turnout",
       x = "Turnout level",

...
### Original Question 1
How did voter turnout in Spanish congressional elections change over the period from 2008 to 2019?

This R code processes and visualizes voter turnout data for Spanish congressional elections. First, it filters the election data to focus only on congressional elections and extracts the election year. Then, it calculates the total census and total votes for each election year. Next, it computes the turnout percentage by dividing total votes by the total census for each year. Finally, it visualizes the turnout trends over time using a line plot, showing how voter participation has changed across different election years.
